...
\begin{frame}{Exploring Responsive Web Design}
  ...
  \begin{itemize}
    ...
    \item Understanding the options for web page layout:
      ...
      \begin{itemize}
        %
        \item {\bf Fixed}: the web page's design assumes a specific viewport
          width
          %
    ...
    \item Liquid layouts often get too ``spread out'' at wide viewports
      ...
      \vspace*{-.2in}
      %
    \item Responsive layouts can add and remove elements and change the layout!
      Wow! But wait, how does that work?
      %
  \end{itemize}
  %
\end{frame}
...
\begin{frame}{Responsive Web Debugging with Firefox}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=.08]{images/responsive-mode-firefox.png}
    \caption{The figure's caption}
  \end{figure}
  %
\end{frame}
